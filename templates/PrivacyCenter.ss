	...
	<div class="privacy-body">
		...
		<div class="rightcol">
			...
			<div id="necessary" class="tabItem">
				...
				<div class="main-text">These cookies are necessary for the website to function and cannot be switched off in our systems. They are usually only set in response to actions made by you which amount to a request for services, such as setting your privacy preferences, logging in or filling in forms.
					<br>
					<br>You can set your browser to block or alert you about these cookies, but some parts of the site will not then work. These cookies do not store any personally identifiable information.
					<div class="cookie-list">
						<div class="cookies-used">Cookies used</div>
					...
					<form>
						<fieldset>
							<p class="privacy-status-on">
								...
								<label for="chkPerformance" id="chkPerformanceLabel" onclick="javascript:switchCookie(this,'cookiePerformanceState');">Active</label>
							</p>
						</fieldset>
					</form>
				</div>
				<div class="main-text">These cookies allow us to count visits and traffic sources so we can measure and improve the performance of our site. They help us to know which pages are the most and least popular and see how visitors move around the site.
					<br>
					<br>All information these cookies collect is aggregated and therefore anonymous. If you do not allow these cookies we will not know when you have visited our site, and will not be able to monitor its performance.
					<div class="cookie-list">
						<div class="cookies-used">Cookies used</div>
					...
					<form>
						<fieldset>
							<p class="privacy-status-on">
								...
								<label for="chkFunctional" id="chkFunctionalLabel" onclick="javascript:switchCookie(this,'cookieFunctionalState');">Active</label>
							</p>
						</fieldset>
					</form>
				</div>
				<div class="main-text">These cookies enable the website to provide enhanced functionality and personalisation. They may be set by us or by third party providers whose services we have added to our pages.
					<br>
					<br>If you do not allow these cookies then some or all of these services may not function properly.
					<div class="cookie-list">
						<div class="cookies-used">Cookies used</div>
			...
			<div id="targeting" class="tabItem">
				<div class="title">T<%t PrivacyCenter.Targeting 'Targeting Cookies'%></div>
				<div class="privacy-status">
					<form>
						<fieldset>
							<p class="privacy-status-on">
								<input type="checkbox" value="check" id="chkTargeting" checked="checked">
								<label for="chkTargeting" id="chkTargetingLabel" onclick="javascript:switchCookie(this,'cookieTargetingState');">Active</label>
							</p>
						</fieldset>
					</form>
				</div>
				<div class="main-text">These cookies may be set through our site by our advertising partners. They may be used by those companies to build a profile of your interests and show you relevant adverts on other sites.
					<br>
					<br>They do not store directly personal information, but are based on uniquely identifying your browser and internet device. If you do not allow these cookies, you will experience less targeted advertising.
					<div class="cookie-list">
						<div class="cookies-used">Cookies used</div>
